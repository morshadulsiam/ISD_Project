                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td><?= $row->pet_id; ?></td>
                                            <td><?= $row->petcatagory; ?></td>
                                            <td><?= $row->petage; ?></td>
                                            <td><?= $row->des; ?></td>
                                            <td><?= $row->cinfo; ?></td>
                                            <td><img src="<?php echo "upload/" . $row->up; ?>" width="150px"></td>
                                            <td><a href="adoptedit.php?id=<?= $row->pet_id; ?>" class="btn btn-primary">Edit</a></td>
                                            <td>
                                                <form action="php/adoptedit.php" method="post">
                                                    <button type="submit" name="delete" value="<?= $row->pet_id; ?>" class="btn btn-danger">
                                ...
                                ?>
                                    <tr>
                                        <td colspan="8">Sorry!! you haven't uploaded anything :(</td>
                                    </tr>
                                <?php
                                }
                                ?>
